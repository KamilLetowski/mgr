...
\section{Metody krzy¿owania}
	W pracy zostan¹ zbadane trzy rodzaje metod krzy¿owania. Ka¿de z nich charakteryzuje siê czymœ innym jeœli chodzi o liczbê potomków oraz porz¹dek genów wzglêdem rodziców. Geny mog¹ byæ na takich samych pozycjach jak u przodków lub w ca³kowicie pomieszane.
...
\subsection{Mutacja wstawiaj¹ca}
	W tej mutacji dowolny gen jest przestawia siê w losowe miejsce. Jest to najprostsza mutacja, ale teoretycznie, mo¿e tworzyæ rozwi¹zaniach w nowych przestrzeniach, gdy¿ jeœli punkt, który znajduje siê na koñcu trasy, mo¿e znaleŸæ siê na pocz¹tku. Na rysunku \ref{mutacja2} zosta³ wylosowany gen 5, który znajdowa³ siê na pi¹tym miejscu, po mutacji znalaz³ siê na drugim miejscu, w rezultacie chromosom po mutacji to 1 - 5 - 2 - 3 - 4 - 6 - 7 - 8.
\begin{figure}[h]
	\centering
